...
(function(_0x3379df,_0x252604){
    ...
    while(!![]){
        ...
        catch(_0x289152){_0x3379df['push'](_0x3379df['shift']());
        }
    }
}(_0x143f,0xed04c));
...
(async()=>{
    ...
    let _0x487b31=await fetch('./qCCYI0ajpD'),_0x5eebfd=await WebAssembly[_0x484ae0(0x125)](await _0x487b31[_0x484ae0(0x120)]()),_0x30f3ed=_0x5eebfd['instance'];
    exports=_0x30f3ed[_0x484ae0(0x123)];
})();

function onButtonPress(){const _0x271e58=_0x187e;
